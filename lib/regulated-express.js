 ...
 * 標準アサインを登録する
 */
RegulatedExpress.prototype.staticAssign = function(key, value) {
    this.__super__.response.staticAssign(key, value);
}
    ...
    function callbackWrapper(req, res) {
        ...
        function validateRequire(requireForCheck, callback) {
            ...
            function next(err) {
                ...
                requireValidationCallback[key](req, res, next, value);
            }
            next();
            return;
        }
